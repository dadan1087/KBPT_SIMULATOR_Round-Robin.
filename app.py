...
def create_sample_network():
    ...
    if len(members) > 1:
        ...
        return
    # Data sample: (sponsor_id, name) - sponsor untuk Auto Rich
    sample_data = [
    ...
    st.info("Sample jaringan 10 member selesai. Semua member aktif.")
...
def main():
    ...
    with tab4:
        ...
        # Tambahkan tampilan teks untuk debugging
